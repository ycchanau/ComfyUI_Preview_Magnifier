...
extensions_folder = os.path.join(folder_web, 'extensions', 'ComfyUI_Preview_Magnifier')

def cleanup():
    if os.path.exists(extensions_folder):
        shutil.rmtree(extensions_folder)
        print('\033[34m3D Preview_Magnifier: \033[92mRemoved old extension folder\033[0m')

cleanup()

print('\033[34mPreview_Magnifier: \033[92mLoaded\033[0m')